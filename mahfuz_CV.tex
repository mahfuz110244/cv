...
Backend Lead Engineer with \textbf{10+ years of experience} designing, modernizing, and scaling distributed systems, microservices, and payment platforms across \textbf{EdTech, FinTech, E-commerce, Logistics, and SaaS}. Currently lead backend engineering at \textbf{Shikho}, Bangladesh's largest EdTech platform (\textbf{3M+ learners}). Deep expertise in Golang and system design, with a track record in legacy modernization, production reliability and performance engineering, team mentoring, and AI-assisted engineering workflows.
...
\begin{cvitems}
  ...
  \item Cut a production DocumentDB cluster from a sustained \textbf{90\% CPU to \textasciitilde{}12\%} by root-causing and fixing change-stream busy-polling across \textasciitilde{}102 cursors.
  \item Architected and shipped \textbf{20+ production microservices} spanning payments, wallet, enrollment, and content platforms.
  % TODO metric: e.g., sustaining ~N req/s at 99.9% uptime
  \item Built the wallet microservice powering balance payments, refunds, and cashbacks for \textbf{Evaly}, a high-traffic e-commerce platform with \textbf{\textasciitilde{}10M users}.
  \item Led monolith-to-microservices migrations and payment-orchestration platforms across EdTech, FinTech, and E-commerce.
  % TODO metric: e.g., deployment time cut ~X% / infra cost reduced ~Y%
\end{cvitems}
...
\begin{cvitems}
  ...
  \item Diagnosed and eliminated a sustained \textbf{90\% CPU} bottleneck on Bohubrihi's production DocumentDB cluster by fixing Go change-stream busy-polling, duplicate listeners, and redundant connection pools; \textbf{CPU fell to \textasciitilde{}12\%} within minutes of deploy.
  \item Design and maintain production Golang microservices focused on scalability, reliability, and maintainability.
  % TODO metric: e.g., serving ~N req/s across core services
  \item Drive backend modernization through API refactoring, service decomposition, and platform optimization, with rigorous architecture review, code review, and incident analysis.
  % TODO metric: e.g., p99 latency / reliability improvement
...
\begin{cvitems}
  ...
  \item Built core, discount, and seller APIs using \textbf{Golang, MongoDB, MySQL, Elasticsearch, and Redis}; refactored legacy services to improve maintainability and stability.
  % TODO metric: e.g., cut p95 latency / defect rate by X%
\end{cvitems}
...
\begin{cvitems}
  ...
  \item Drove migration of the Bohubrihi WordPress monolith to a scalable microservices architecture with independently deployable services.
  % TODO metric: e.g., uptime or page-load improved by X
...
\roleentry{Senior Software Engineer}{Feb 2021 -- Sep 2021}{Evaly Ltd.}{Dhanmondi, Dhaka}
\begin{cvitems}
  \item Built a high-throughput \textbf{wallet} microservice for balance payments, refunds, and cashbacks serving \textbf{\textasciitilde{}10M users}.
  % TODO metric: e.g., ~N TPS / $X monthly volume
  \item Built payment-orchestration integrations with \textbf{bKash, Nagad, SSLCommerz, Balance, and Gift Card}; optimized queries and caching to reduce AWS cost and improve response times.
  % TODO metric: e.g., AWS cost reduced by ~X%
\end{cvitems}
...
\projectentry{Bohubrihi}{Online learning platform migrated from WordPress monolith to \textbf{7 production microservices}; led backend service decomposition and delivery, including a production performance fix that took the platform's DocumentDB cluster from \textasciitilde{}90\% to \textasciitilde{}12\% CPU.}{Golang, MongoDB, AWS DocumentDB, PostgreSQL, Redis, RabbitMQ, NATS, Docker, GraphQL}
